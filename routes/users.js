...

{
  ...
  const fetchDress = async () => {
    try {
        const response = await axios.get('https://www.amazon.com/s?k=shoes+for+boys&i=fashion-boys-intl-ship&crid=3GDD7UA06M1S1&sprefix=shos%2Cfashion-boys-intl-ship%2C574&ref=nb_sb_ss_sc_1_5')
